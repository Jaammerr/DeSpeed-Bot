...
class Console:
    ...
    def display_info(self):
        ...
        app_settings_table.add_row("Check Uniqueness of Proxies", str(config.application_settings.check_uniqueness_of_proxies))
        app_settings_table.add_row("Gen Random Password for Accounts", str(config.application_settings.gen_random_pass_for_accounts))
        app_settings_table.add_row("Auto Claim Daily Reward", str(config.application_settings.auto_claim_daily_reward))
        # Redirect Settings
        ...
        accounts_table.add_row("Accounts to verify", str(len(config.accounts_to_verify)))
